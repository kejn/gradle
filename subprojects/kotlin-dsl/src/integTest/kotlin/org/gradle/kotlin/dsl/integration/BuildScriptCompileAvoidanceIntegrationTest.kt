...
class BuildScriptCompileAvoidanceIntegrationTest : AbstractKotlinIntegrationTest() {
    ...
    fun `recompiles buildscript when not able to determine Kotlin metadata kind for class on buildscript classpath`() {
        ...
        configureProject().assertBuildScriptCompiled().assertOutputContains("foo").assertOutputContains("Unknown Kotlin metadata detected on classpath for class")
        ...
        configureProject().assertBuildScriptBodyRecompiled().assertOutputContains("foo").assertOutputContains("Unknown Kotlin metadata detected on classpath for class")
    }
